<template>
  <div class="relative">
        ...
        <div class="flex justify-between h-20">
          ...
          <nav class="hidden md:flex items-center space-x-6 cursor-pointer">
            ...
            <a href="tel:+923001234567">
              <button class="px-10 py-3 bg-yellow-400 rounded-lg cursor-pointer">
                Call Now
              </button>
            </a>
    ...
    <div class="fixed inset-0 z-40 transform ease-in-out duration-300"
      ...
      <nav class="relative w-72 max-w-sm bg-slate-900 h-full  shadow-xl flex flex-col rounded-r-lg">
        ...
        <div class="flex-1 overflow-y-auto">
          <div class="px-2 py-4 space-y-2">
            <router-link v-for="(link, index) in navLinks" :key="index" :to="link.path" @click="closeSidebar"
